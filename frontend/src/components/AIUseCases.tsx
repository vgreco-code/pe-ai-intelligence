...
const COMPANY_USE_CASES: Record<string, UseCase[]> = {
  "Dash": [
    { title: 'AI Policy Generation from Natural Language', description: 'Extend CloudScanner\'s plain-English policy engine with LLM-powered policy authoring — security teams describe compliance intent and the system generates enforceable AWS policies automatically.', impact: 'High', timeframe: '3-6 months', category: 'Core Product' },
    { title: 'Predictive Compliance Drift Detection', description: 'Build ML models on historical compliance scan data to predict which resources are likely to drift out of compliance before violations occur — shift from reactive scanning to proactive prevention.', impact: 'High', timeframe: '6-9 months', category: 'Core Product' },
    { title: 'Automated Evidence Collection for Audits', description: 'AI-powered evidence gathering that automatically maps control requirements to AWS resource configurations, generating audit-ready documentation packages for SOC 2, HIPAA, and ISO 27001.', impact: 'Medium', timeframe: '3-5 months', category: 'Operations' },
    { title: 'Multi-Cloud Compliance Expansion', description: 'Leverage CloudScanner\'s architecture to extend AI compliance monitoring to Azure and GCP — the Relevance Lab partnership provides the multi-cloud framework.', impact: 'High', timeframe: '9-12 months', category: 'Revenue' },
  ],
  "Track Star": [
